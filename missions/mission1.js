...
const diagram = [
    [ // node data
      ...
      { key: "Phase1", text: "Phase 1", isGroup: true, category: "Pool" },
        { key: "Action1-1", text: "depth", isGroup: true, group: "Phase1", color: "#CCCCCC" },
        { key: "Block1-1-1", text: "Start", group: "Action1-1", category: "terminal" },
        { key: "Block1-1-2", text: "{}", group: "Action1-1", category: "param",
      ...
      { key: "Phase2", text: "Phase 2", isGroup: true, category: "Pool" },
        { key: "Action2-1", text: "record", isGroup: true, group: "Phase2", color: "#CCCCCC" },
        //{ key: "Block2-1-1", text: "If Depth > 1.5m", group: "Action2-1", color: "#D2E0E3" },
        { key: "Block2-1-2", text: "Record Video", group: "Action2-1", category: "label" },
        { key: "Block2-1-3", text: "{}", group: "Action2-1", category: "param",
        ...
        { key: "Action2-2", text: "next", isGroup: true, group: "Phase2", color: "#CCCCCC" },
        //{ key: "Block2-2-1", text: "If Depth > 1.5m", group: "Action2-2", color: "#D2E0E3" },
        { key: "Block2-2-2", text: "Pause Video", group: "Action2-2", category: "label" },
        { key: "Block2-2-3", text: "{}", group: "Action2-2", category: "param",
        ...
        { key: "Action3-1", text: "end", isGroup: true, group: "Phase3", color: "#CCCCCC" },
        { key: "Block3-1-1", text: "End", group: "Action3-1", category: "terminal", },
        { key: "Block3-1-2", text: "{}", group: "Action3-1", category: "param",
