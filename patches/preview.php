<?php
   ...
   define('BTN_DELETEALL', '<b>Delete All<b>');
...
<html>
   ...
   <body>
	 ...
	 -->
         <button class='btn btn-danger' type='submit' name='action' value='deleteAll' style='color:green;min-width:280px;' onclick="return confirm('<?php echo BTN_DELETEALL_CONFIRM; ?>')"><?php echo BTN_DELETEALL; ?></button>
         </h1>
	 <br>
         <?php
         diskUsage();
