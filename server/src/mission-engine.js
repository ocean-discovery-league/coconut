...
class MissionEngine extends EventEmitter {
    ...
    start(mission, sensors) {
        ...
        // TODO should we reset raspiMJPEG to a known starting state?
        // maybe not. we *seem* to set all the modes whenever we change actions
        // and if we don't reset it here we won't interrupt stuff in photo/video mode
    }
