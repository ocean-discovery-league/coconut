    ...
    function init() {
      ...
      myDiagram.model = new go.GraphLinksModel(
        [ // node data
          ...
          { key: "Action3", text: "Action3", isGroup: true, group: "Phase1", color: "lightyellow" },
          { key: "Action4", text: "Action4", isGroup: true, group: "Phase1", color: "orange" },
          ...
          { key: "fourA", group: "Action4" },
          { key: "fourB", group: "Action4" },
          { key: "fourC", group: "Action4" },
          { key: "fourD", group: "Action4" },
          { key: "Action5", text: "Action5", isGroup: true, group: "Phase2", color: "lightyellow" },
          { key: "Action6", text: "Action6", isGroup: true, group: "Phase2", color: "lightgreen" },
          { key: "fiveA", group: "Action5" },
          { key: "sixA", group: "Action6" }
        ],
        [ // link data
          { from: "oneA", to: "oneB" },
          { from: "oneA", to: "oneC" },
