 (function() {
    ...
    function selectionChangedHandler(part) {
        ...
        let label_el = document.querySelectorAll('#label-1')[0];
        let toolbox = document.querySelectorAll('#toolbox-1')[0];
    ...
    window.mission1.init = 
        function() {
            ...
            missionOneDiagram.groupTemplateMap.add(
		"Pool",
	    ...
	    let mission1a = [
                [ // node data
                  ...
                  { key: "Phase2", text: "Record", isGroup: true, category: "Pool" },
                    { key: "Action2-1", text: "record", isGroup: true, group: "Phase2", color: "lightblue" },
                    { key: "Block2-1-1", text: "⏺  Video 24fps", group: "Action2-1", color: "lightgreen"},
                    { key: "Action2-2", text: "next", isGroup: true, group: "Phase2", color: "lightblue" },
                    { key: "Block2-2-1", text: "⏱ 5min", group: "Action2-1" },
                    { key: "Block2-2-2", text: "Next Phase", group: "Action2-1" },
                  ...
                  { key: "Phase3", text: "Pause", isGroup: true, category: "Pool" },
                    { key: "Action3-1", text: "next", isGroup: true, group: "Phase3", color: "lightblue" },
                    { key: "Block3-1-1", text: "⏱ 15min", group: "Action3-1" },
                    { key: "Block3-1-2", text: "Previous Phase", group: "Action3-1" },
                    { key: "Action3-2", text: "end", isGroup: true, group: "Phase3", color: "orange" },
                    { key: "Block3-2-1", text: "> 200m", group: "Action3-2" },
                    { key: "Block3-2-2", text: "End Mission", group: "Action3-2", color: "red" },
                ],
                [ // link data
                    ...
                    { from: "Block3-1-2", to: "Phase2" },
                    { from: "Block3-2-1", to: "Block3-2-2" },
                ]
	    ];
	    ...
	    let mission = mission1a;
            missionOneDiagram.model = new go.GraphLinksModel(mission[0], mission[1]);

	    let json = missionOneDiagram.model.toJson();
